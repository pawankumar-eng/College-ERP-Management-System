...
<head>
    ...
    <style>
        * {
        ...
        body {
            background-color: #f4f7f6; /* Professional light gray-greenish */
            min-height: 100vh;
            display: flex;
            align-items: center;
...
<div class="container">
    ...
    <div class="menu-grid">
        <a href="markAttendance.jsp" class="menu-item">Mark Attendance</a>
        <a href="addMarks.jsp" class="menu-item">Add Marks</a>
