...
PreparedStatement ps = con.prepareStatement("SELECT * FROM attendance WHERE admission_no=?");
...
<div class="container">
    ...
    <table>
        ...
        <% while(rs.next()) { 
            ...
            String statusClass = "Present".equalsIgnoreCase(status) ? "status-present" : "status-absent";
        %>
        <tr>
